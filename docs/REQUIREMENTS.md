...
| In-context worker mode + streaming instruction queue + ERR + monitoring-pause visibility (FR-46..49, UC-9) | PENDING — v0.1.0 build; dogfood as the QPB runner before public ship |
